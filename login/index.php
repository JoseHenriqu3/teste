            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="autenticar.php" method="POST">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Digite seu nome de usuário">
                        <label for="usuario" class="col-md-3 col-sm-3 form-label"><span
                                class="login">Usuário:</span></label>
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <a href="../" class="btn btn-outline-primary btn-custom mt-5">
                            <span class="glyphicon glyphicon-ok img-circle text- btn-icon"></span>
                            <b>SAIR</b>
                        </a>
                    </div>
                </form>

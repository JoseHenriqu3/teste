...
<head>
    ...
    <link rel="stylesheet" href="../vendor/css/teste.css">
...
<head>
    <!-- Seu conteúdo do cabeçalho aqui -->
</head>
...
<body class="body">
    <div class='checkout'>
        <div class="row">
            <!-- Primeira coluna -->
            <div class="col-md-6 col-sm-12 mb-4" style="background-color: white;">
                <div class='order py-2'>
                    <div class="col-lg-12 mb-">
                        <div class="card shadow">
                            <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
            ...
            <!-- Segunda coluna -->
                    ...
                    <div class="col-md-4 col-sm-12 mb-4" style="background-color: white;">
                        <div class="order py-2">
                            <div class="col-lg-12 mb-">
                                <div class="card shadow">
                                    <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 mt-4">
                                    <img id="imagem" src="" alt="Imagem" class="img-fluid" style="border-radius: 15px;">
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="order py-2">
                                        <div class="col-lg-12 mb-">
                                            <div class="card shadow">
                                                <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                                    <h7 class="m-0 font-weight-bold text-white">ESTOQUE</h7>
                                                </div>
                        ...
                        <div class="col-md-2 col-sm-12 mb-4" style="background-color: white;">
                            <div class="order py-2">
                                <div class="col-lg-12 mb-">
                                    <div class="card shadow">
                                        <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                            <h7 class="m-0 font-weight-bold text-white">TOTAL DO ITEM R$</h7>
                                        </div>
                                        <input type="text" class="form-control form-control-md" id="total_item" name="total_item" placeholder="Total em R$">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="order py-2">
                                <div class="col-lg-12 mb-">
                                    <div class="card shadow">
                                        <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                            <h7 class="m-0 font-weight-bold text-white">SUB TOTAL</h7>
                                        </div>
                            ...
                            <div class="order py-2">
                                <div class="col-lg-12 mb-">
                                    <div class="card shadow">
                                        <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                            <h7 class="m-0 font-weight-bold text-white">DESCONTO EM %</h7>
                                        </div>
                            ...
                            <div class="order py-2">
                                <div class="col-lg-12 mb-">
                                    <div class="card shadow">
                                        <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                            <h7 class="m-0 font-weight-bold text-white">TOTAL COMPRA</h7>
                                        </div>
                            ...
                            <div class="order py-2">
                                <div class="col-lg-12 mb-">
                                    <div class="card shadow">
                                        <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                            <h7 class="m-0 font-weight-bold text-white">VALOR RECEBIDO</h7>
                                        </div>
                            ...
                            <div class="order py-2">
                                <div class="col-lg-12 mb-">
                                    <div class="card shadow">
                                        <div class="card-header py-1" style="background: linear-gradient(to right, #FF0000, #FFFFFF);">
                                            <h7 class="m-0 font-weight-bold text-white">TROCO</h7>
                                        </div>
                        ...
                        <div class="text-center">
                            <h1 style="font-size: 30px; font-family: 'Times New Roman', Times, serif; color:white;">FROM</h1>
                        </div>
                        <div class="img-fluid text-center">
                            <img src="../img/Captura_de_tela_2023-08-20_203157-removebg-preview(2).png" style="width: 170px; margin-top: -20px;">
                        </div>
